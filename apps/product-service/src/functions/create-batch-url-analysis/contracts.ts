...
/**
 * Request body schema for POST /url-analysis/batch
 */
export const createBatchUrlAnalysisRequestSchema = z
  .object({
    urls: z
      .array(urlItemSchema)
  ...
  .openapi('CreateBatchUrlAnalysisRequest');
...
/**
 * Success response schema for batch analysis
 */
export const createBatchUrlAnalysisResponseSchema = z
  .object({
  ...
  .openapi('CreateBatchUrlAnalysisResponse');
...
export type CreateBatchUrlAnalysisRequest = z.infer<typeof createBatchUrlAnalysisRequestSchema>;
export type CreateBatchUrlAnalysisResponse = z.infer<typeof createBatchUrlAnalysisResponseSchema>;
