...
import { assertProductIdsMatch, END_OF_STRING_CHARS } from './testUtils.js';
import { parseUrlComponents } from '../../parseUrlComponents/parseUrlComponents.js';
import { extractIdsFromUrlComponents } from '../extractIdsFromUrlComponents.js';
...
describe('Path extraction patterns', () => {
  ...
  it('should not exceed maximum number of results defined in config', () => {
    assertProductIdsMatch({
      ...
      expectedSkus: [
        'p111111111', '111111111',
        'p222222222', '222222222',
        'p333333333', '333333333',
        'p444444444', '444444444',
        'p555555555', '555555555',
        'p666666666', '666666666'
  ...
  it('should ensure result array length never exceeds MAX_RESULTS', () => {
    const url = 'https://example.com/p111111111/p222222222/p333333333/p444444444/p555555555/p666666666/p777777777/p888888888/p999999999/p000000000/p121212121/p131313131/p141414141';
