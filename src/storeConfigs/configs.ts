...
export const storeConfigs: StoreConfigInterface[] = [
  ...
  },
  {
    ...
    pathnamePatterns: [buildRegExp([
      ...
      capture(
        repeat(
          choiceOf('pimprod', 'xlsimpprod', digit),
          { min: 6, max: 24 }
        )
      ),
  ...
  },
  {
    ...
    pathnamePatterns: [
      ...
      buildRegExp([
        "/",
        capture([
          repeat(word, { min: 1, max: 5 }),
          repeat(digit, { min: 3, max: 8 })
        ]),
        choiceOf(
          "_",
          endOfString,
