/**
 * Cart Enricher Test Fixtures
 *
 * Real-world test cases for validating cart-to-product matching logic.
 * Each fixture contains raw event data and expected match results.
 */
